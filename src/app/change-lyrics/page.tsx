                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-3">
                                <input type="text" value={replaceTerm} onChange={e => setReplaceTerm(e.target.value)}
                                    ...
                                    className="w-full h-14 px-5 rounded-2xl border border-black/10 bg-white text-base text-black placeholder:text-black/25 focus:outline-none focus:ring-4 focus:ring-black/5 focus:border-black/20 transition-all" />
