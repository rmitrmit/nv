        ...
        <Tooltip.Root>
            <Tooltip.Trigger asChild>
                ...
                >
                    ...
                    <p
                        className="scroll-m-20 font-roboto text-sm leading-normal tracking-wide dark:text-black mt-2 text-center font-semibold text-black peer-disabled:font-normal peer-disabled:opacity-10"
            ...
            <Tooltip.Portal>
                <Tooltip.Content
                    className="bg-black/90 text-black px-3 py-1.5 rounded text-sm"
                    sideOffset={5}
                >
                    {label}
